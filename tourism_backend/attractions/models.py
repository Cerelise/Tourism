...
class AttractionsPicture(models.Model):
    ...
    related_attr = models.ForeignKey(Attraction,on_delete=models.CASCADE,related_name='pictures')
    created_at = models.DateTimeField(auto_now_add=True)
...
class Paragraph(models.Model):
    ...
    content = models.TextField()
    created_at = models.DateTimeField(auto_now_add=True)
    related_article = models.ForeignKey(AttractionsArticle,on_delete=models.CASCADE,related_name='paragraphs')
